# Flizow — Developer Handoff

This folder contains everything you need to start building Flizow against our existing mockup. The mockup is interactive and reflects the intended product behavior — use it as the spec for layout, copy, and interactions.

## Read these in order

1. **[01-overview.md](01-overview.md)** — What Flizow is, who uses it, and the live URL to click through.
...
- **Mockup file:** `public/flizow-test.html` (single-file, ~16k lines, no build step). Open in any browser.
- **Live URL:** https://nikkortrinidad-cpu.github.io/kanban-website/flizow-test.html
...
- **Data layer:** All synthesized at runtime into `window.FLIZOW_DATA` (50 clients, ~150 services, ~1000 tasks, 5 team members). Use this shape as the source of truth for your schema.
